...
const warning: DeepPartial<Translation["warning"]> = {
    ...
    browserNotSupported: {
        ...
        message: "Trình duyệt của bạn ({browserName}) không còn được NG Academy hỗ trợ.",
        description:
            "Trình duyệt của bạn quá cũ để chạy NG Academy. Vui lòng cập nhật lên phiên bản mới nhất để tiếp tục.",
        whatToDo: "Bạn có thể làm gì?",
        option1: "Cập nhật {browserName} lên phiên bản mới nhất",
        option2: "Rời NG Academy và dùng một trình duyệt khác",
        updateBrowser: "Cập nhật trình duyệt",
        leave: "Rời đi",
    },
    pwaInstall: {
        title: "Cài đặt NG Academy",
        description:
            "Cài đặt ứng dụng để có trải nghiệm tốt hơn: truy cập nhanh, khởi động cùng máy và trải nghiệm như ứng dụng riêng.",
        descriptionIos: "Thêm NG Academy vào Màn hình chính để có trải nghiệm tốt hơn và truy cập nhanh.",
        feature1Title: "Truy cập nhanh",
        feature1Description: "Mở NG Academy từ menu Start, Dock hoặc màn hình nền của bạn.",
        feature2Title: "Cửa sổ ứng dụng riêng",
        feature2Description: "Tách NG Academy khỏi các thẻ trình duyệt và tìm thấy NG Academy ngay trên thanh tác vụ.",
        feature3Title: "Khởi động cùng máy tính",
        feature3Description: "Mở NG Academy khi thiết bị của bạn khởi động.",
        ...
        install: "Cài đặt ứng dụng NG Academy",
