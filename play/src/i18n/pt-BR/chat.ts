...
const chat: DeepPartial<Translation["chat"]> = {
    ...
    matrixSettings: {
        ...
        accountDataSection: "NG Academy (no jogo)",
        ...
        publishWokaToMatrixProfileConfirmWarning:
            "Isso substitui o nome de exibição e o avatar do seu perfil Matrix no servidor. Qualquer nome ou foto definidos em outro lugar (por exemplo, no Element) será substituído. Continue apenas se quiser que seu nome NG Academy e seu WOKA se tornem seu perfil Matrix público.",
