...
const warning: BaseTranslation = {
    ...
    browserNotSupported: {
        ...
        message: "Seu navegador ({browserName}) não é mais suportado pelo NG Academy.",
        description:
            "Seu navegador está muito antigo para executar NG Academy. Por favor, atualize-o para a versão mais recente para continuar.",
        whatToDo: "O que você pode fazer?",
        option1: "Atualizar {browserName} para a versão mais recente",
        option2: "Sair do NG Academy e usar um navegador diferente",
        updateBrowser: "Atualizar navegador",
        leave: "Sair",
    },
    pwaInstall: {
        title: "Instalar NG Academy",
        description:
            "Instale o app para ter uma experiência melhor: acesso rápido, inicialização automática e uma experiência de app.",
        descriptionIos: "Adicione o NG Academy à Tela de Início para ter uma experiência melhor e acesso rápido.",
        feature1Title: "Acesso rápido",
        feature1Description: "Abra o NG Academy pelo menu Iniciar, Dock ou área de trabalho.",
        feature2Title: "Janela dedicada do app",
        feature2Description:
            "Mantenha o NG Academy separado das abas do navegador e encontre o NG Academy rapidamente na barra de tarefas.",
        feature3Title: "Iniciar com o computador",
        feature3Description: "Abra o NG Academy quando o dispositivo iniciar.",
        ...
        install: "Instalar o app NG Academy",
