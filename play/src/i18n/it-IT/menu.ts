...
const menu: DeepPartial<Translation["menu"]> = {
    ...
    settings: {
        ...
        microphone: {
            ...
            workAdventureNoiseSuppression: "Soppressione del rumore NG Academy",
            workAdventureNoiseSuppressionDescription:
                "Elabora il microfono con la soppressione del rumore di NG Academy.",
        ...
        privacySettings: {
            ...
            explanation:
                'Quando la scheda NG Academy nel tuo browser non è visibile, NG Academy passa alla modalità "assente"',
    ...
    contact: {
        gettingStarted: {
            title: "Iniziare",
            description:
                "NG Academy ti permette di creare uno spazio online per comunicare spontaneamente con gli altri. E tutto inizia con la creazione del tuo spazio. Scegli tra una vasta selezione di mappe prefabbricate dal nostro team.",
        },
        createMap: {
