...
const warning: DeepPartial<Translation["warning"]> = {
    ...
    browserNotSupported: {
        ...
        message: "Il tuo browser ({browserName}) non è più supportato da NG Academy.",
        description:
            "Il tuo browser è troppo vecchio per eseguire NG Academy. Si prega di aggiornarlo all'ultima versione per continuare.",
        whatToDo: "Cosa puoi fare?",
        option1: "Aggiornare {browserName} all'ultima versione",
        option2: "Uscire da NG Academy e utilizzare un browser diverso",
        updateBrowser: "Aggiorna browser",
        leave: "Esci",
    },
    pwaInstall: {
        title: "Installa NG Academy",
        description:
            "Installa l'app per un'esperienza migliore: accesso rapido, avvio automatico e un'esperienza simile a quella di un'app.",
        descriptionIos: "Aggiungi NG Academy alla schermata Home per un'esperienza migliore e un accesso rapido.",
        feature1Title: "Accesso rapido",
        feature1Description: "Avvia NG Academy dal menu Start, dal Dock o dal desktop.",
        feature2Title: "Finestra dell'app dedicata",
        feature2Description:
            "Tieni NG Academy separato dalle schede del browser e ritrovalo a colpo d'occhio nella barra delle applicazioni.",
        feature3Title: "Avvia con il computer",
        feature3Description: "Avvia NG Academy quando il dispositivo si accende.",
        ...
        install: "Installa l'app NG Academy",
