...
const notification: DeepPartial<Translation["notification"]> = {
    ...
    help: {
        ...
        content:
            "Non perdere nessuna discussione. Abilita le notifiche per essere avvisato quando qualcuno vuole parlare con te, anche se non sei sulla scheda NG Academy.",
        firefoxContent:
