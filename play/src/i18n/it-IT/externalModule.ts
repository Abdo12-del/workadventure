...
const externalModule: DeepPartial<Translation["externalModule"]> = {
    ...
    outlook: {
        ...
        popupScopeToSyncExplainText:
            "Dobbiamo connetterci al tuo account Outlook per sincronizzare il tuo calendario e/o le tue attività. Questo ti permetterà di visualizzare le tue riunioni e attività in NG Academy e parteciparvi direttamente dalla mappa.",
    ...
    google: {
        ...
        popupScopeToSyncExplainText:
            "Dobbiamo connetterci al tuo account Google per sincronizzare il tuo calendario e/o le tue attività. Questo ti permetterà di visualizzare le tue riunioni e attività in NG Academy e parteciparvi direttamente dalla mappa.",
        popupScopeToSyncCalendar: "Sincronizza il mio calendario",
        popupScopeToSyncTask: "Sincronizza le mie attività",
        popupCancel: "Annulla",
