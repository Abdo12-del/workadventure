...
const menu: DeepPartial<Translation["menu"]> = {
    ...
    settings: {
        ...
        microphone: {
            ...
            workAdventureNoiseSuppression: "Réduction du bruit NG Academy",
            workAdventureNoiseSuppressionDescription:
                "Traite votre microphone avec la réduction du bruit de NG Academy.",
        ...
        privacySettings: {
            title: "Mode absent",
            explanation:
                "Quand l'onglet NG Academy de votre navigateur n'est pas visible, NG Academy passe en \"mode absent\"",
    ...
    contact: {
        gettingStarted: {
            ...
            description:
                "NG Academy vous permet de créer un espace en ligne pour communiquer spontanément avec d'autres personnes. Et tout commence par la création de votre propre espace. Choisissez parmi une large sélection de cartes préfabriquées par notre équipe.",
        },
        createMap: {
