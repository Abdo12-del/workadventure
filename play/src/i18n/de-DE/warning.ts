...
const warning: DeepPartial<Translation["warning"]> = {
    ...
    browserNotSupported: {
        ...
        message: "Ihr Browser ({browserName}) wird von NG Academy nicht mehr unterstützt.",
        description:
            "Ihr Browser ist zu alt, um NG Academy auszuführen. Bitte aktualisieren Sie ihn auf die neueste Version, um fortzufahren.",
        whatToDo: "Was können Sie tun?",
        option1: "{browserName} auf die neueste Version aktualisieren",
        option2: "NG Academy verlassen und einen anderen Browser verwenden",
        updateBrowser: "Browser aktualisieren",
        leave: "Verlassen",
    },
    pwaInstall: {
        title: "NG Academy installieren",
        description:
            "Installieren Sie die App für ein besseres Erlebnis: schneller Zugriff, automatischer Start und ein app-ähnliches Erlebnis.",
        descriptionIos:
            "Fügen Sie NG Academy für ein besseres Erlebnis und schnellen Zugriff zu Ihrem Home-Bildschirm hinzu.",
        feature1Title: "Schneller Zugriff",
        feature1Description: "Starten Sie NG Academy über Ihr Startmenü, Dock oder Ihren Desktop.",
        feature2Title: "Eigenes App-Fenster",
        feature2Description:
            "Halten Sie NG Academy getrennt von Ihren Browser-Tabs und finden Sie NG Academy auf einen Blick in Ihrer Taskleiste.",
        feature3Title: "Mit dem Computer starten",
        feature3Description: "Starten Sie NG Academy, wenn Ihr Gerät hochfährt.",
        ...
        install: "NG Academy-App installieren",
