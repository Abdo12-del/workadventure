...
const menu: DeepPartial<Translation["menu"]> = {
    ...
    settings: {
        ...
        microphone: {
            ...
            workAdventureNoiseSuppression: "NG Academy-Geräuschunterdrückung",
            workAdventureNoiseSuppressionDescription:
                "Verarbeite dein Mikrofon mit der Geräuschunterdrückung von NG Academy.",
            recommended: "Empfohlen",
        ...
        privacySettings: {
            ...
            explanation: "Falls der NG Academy-Tab nicht aktiv ist, wird in den „Abwesenheitsmodus“ umgeschaltet.",
    ...
    contact: {
        gettingStarted: {
            ...
            description:
                "Mit NG Academy kannst du eine Onlinewelt erschaffen, in der du dich spontan mit anderen treffen und unterhalten kannst. Erstelle als erstes deine eigene Karte. Es steht dir eine große Auswahl an vorgefertigten Karten von unserem Team zur Verfügung.",
        },
        createMap: {
