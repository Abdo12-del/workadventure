...
const externalModule: DeepPartial<Translation["externalModule"]> = {
    ...
    outlook: {
        ...
        popupScopeToSyncExplainText:
            "Wir müssen uns mit Ihrem Outlook-Konto verbinden, um Ihren Kalender und/oder Ihre Aufgaben zu synchronisieren. Dies ermöglicht es Ihnen, Ihre Besprechungen und Aufgaben in NG Academy anzuzeigen und direkt von der Karte aus daran teilzunehmen.",
    ...
    google: {
        ...
        popupScopeToSyncExplainText:
            "Wir müssen uns mit Ihrem Google-Konto verbinden, um Ihren Kalender und/oder Ihre Aufgaben zu synchronisieren. Dies ermöglicht es Ihnen, Ihre Besprechungen und Aufgaben in NG Academy anzuzeigen und direkt von der Karte aus daran teilzunehmen.",
        popupScopeToSyncCalendar: "Meinen Kalender synchronisieren",
        popupScopeToSyncTask: "Meine Aufgaben synchronisieren",
        popupCancel: "Abbrechen",
