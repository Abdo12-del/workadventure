...
const externalModule: DeepPartial<Translation["externalModule"]> = {
    ...
    discord: {
        integration: "整合",
        explainText:
            "在此處連線您的 Discord 帳戶後，您將能夠在 NG Academy 聊天中直接接收訊息。同步伺服器後，我們會建立其中包含的房間，您只需在 NG Academy 聊天中加入它們即可。",
        login: "連線到 Discord",
        ...
        guilds: "Discord 伺服器",
        guildExplain: "選擇要加入 NG Academy 聊天介面的頻道。\n",
    },
    outlook: {
        signIn: "使用 Outlook 登入",
        popupScopeToSync: "連線我的 Outlook 帳戶",
        popupScopeToSyncExplainText:
            "我們需要連線到您的 Outlook 帳戶以同步您的行事曆和／或工作。這將讓您在 NG Academy 中查看您的會議和工作，並直接從地圖加入它們。",
    ...
    google: {
        ...
        popupScopeToSyncExplainText:
            "我們需要連線到您的 Google 帳戶以同步您的行事曆和／或工作。這將讓您在 NG Academy 中查看您的會議和工作，並直接從地圖加入它們。",
        popupScopeToSyncCalendar: "同步我的行事曆",
        popupScopeToSyncTask: "同步我的工作",
        popupCancel: "取消",
