...
const mapEditor: DeepPartial<Translation["mapEditor"]> = {
    ...
    properties: {
        ...
        openWebsite: {
            label: "開啟連結",
            description: "在 NG Academy 內或以新分頁開啟網站。",
            linkLabel: "連結 URL",
            newTabLabel: "在新分頁中開啟",
            trigger: "互動",
            triggerMessage: "提示訊息",
        ...
        youtube: {
            label: "開啟 YouTube 影片",
            description: "在 NG Academy 內或以新分頁開啟 YouTube 影片。",
        ...
        googleDocs: {
            label: "開啟 Google 文件",
            description: "在 NG Academy 內或以新分頁開啟 Google 文件。",
        ...
        klaxoon: {
            label: "開啟 Klaxoon",
            description: "在 NG Academy 內或以新分頁開啟 Klaxoon。",
        ...
        googleSheets: {
            label: "開啟 Google 試算表",
            description: "在 NG Academy 內或以新分頁開啟 Google 試算表。",
        ...
        googleSlides: {
            label: "開啟 Google 簡報",
            description: "在 NG Academy 內或以新分頁開啟 Google 簡報。",
        ...
        googleDrive: {
            ...
            description: "在 NG Academy 內或以新分頁開啟 Google 雲端硬碟。",
        ...
        openFile: {
            label: "開啟檔案",
            description: "在 NG Academy 內開啟檔案。",
            error: "請輸入有效的檔案",
            disabled: "檔案整合已停用。",
            fileUrlLabel: "檔案 URL",
            uploadFile: {
