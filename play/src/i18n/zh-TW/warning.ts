...
const warning: DeepPartial<Translation["warning"]> = {
    ...
    browserNotSupported: {
        title: "😢 不支援的瀏覽器",
        message: "您的瀏覽器（{browserName}）不再受 NG Academy 支援。",
        description: "您的瀏覽器太舊，無法執行 NG Academy。請更新至最新版本以繼續。",
        whatToDo: "您可以怎麼做？",
        option1: "將 {browserName} 更新至最新版本",
        option2: "退出 NG Academy 並使用其他瀏覽器",
        updateBrowser: "更新瀏覽器",
        leave: "離開",
    },
    pwaInstall: {
        ...
        descriptionIos: "將 NG Academy 加入主畫面，以獲得更好的體驗和快速存取。",
        feature1Title: "快速存取",
        feature1Description: "從開始選單、Dock 或桌面啟動 NG Academy。",
        feature2Title: "獨立應用程式視窗",
        feature2Description: "讓 NG Academy 與瀏覽器分頁分開，並可在工作列中一眼找到它。",
        feature3Title: "隨電腦啟動",
        feature3Description: "在裝置啟動時啟動 NG Academy。",
        iosStepsTitle: "如何安裝",
        iosStep1: "在 Safari 底部點選「分享」按鈕（帶箭頭的方框）。",
        iosStep2: "向下捲動並點選「加入主畫面」。",
        iosStep3: "點選「加入」以確認。",
        install: "安裝 NG Academy 應用程式",
        installing: "安裝中…",
        skip: "在瀏覽器中繼續",
        continue: "在瀏覽器中繼續",
        neverShowPage: "不再詢問",
