...
const warning: DeepPartial<Translation["warning"]> = {
    ...
    browserNotSupported: {
        ...
        message: "เบราว์เซอร์ของคุณ ({browserName}) ไม่ได้รับการรองรับจาก NG Academy อีกต่อไป",
        description:
            "เบราว์เซอร์ของคุณเก่าเกินกว่าจะใช้งาน NG Academy ได้ กรุณาอัปเดตเป็นเวอร์ชันล่าสุดเพื่อดำเนินการต่อ",
        whatToDo: "คุณทำอะไรได้บ้าง?",
        option1: "อัปเดต {browserName} เป็นเวอร์ชันล่าสุด",
        option2: "ออกจาก NG Academy และใช้เบราว์เซอร์อื่น",
        updateBrowser: "อัปเดตเบราว์เซอร์",
        leave: "ออก",
    },
    pwaInstall: {
        title: "ติดตั้ง NG Academy",
        description: "ติดตั้งแอปเพื่อประสบการณ์ที่ดียิ่งขึ้น: เข้าถึงได้รวดเร็ว เปิดพร้อมเครื่อง และใช้งานเหมือนแอป",
        descriptionIos: "เพิ่ม NG Academy ลงในหน้าจอโฮมของคุณเพื่อประสบการณ์ที่ดีขึ้นและการเข้าถึงที่รวดเร็ว",
        feature1Title: "เข้าถึงรวดเร็ว",
        feature1Description: "เปิด NG Academy จากเมนู Start, Dock หรือเดสก์ท็อปของคุณ",
        feature2Title: "หน้าต่างแอปโดยเฉพาะ",
        feature2Description: "แยก NG Academy ออกจากแท็บเบราว์เซอร์ และเห็น NG Academy ได้ทันทีในทาสก์บาร์ของคุณ",
        feature3Title: "เริ่มพร้อมคอมพิวเตอร์ของคุณ",
        feature3Description: "เปิด NG Academy เมื่ออุปกรณ์ของคุณเริ่มทำงาน",
