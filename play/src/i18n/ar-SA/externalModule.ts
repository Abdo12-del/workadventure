...
const externalModule: DeepPartial<Translation["externalModule"]> = {
    ...
    outlook: {
        ...
        popupScopeToSyncExplainText:
            "نحتاج إلى الاتصال بحساب Outlook الخاص بك لمزامنة تقويمك و/أو مهامك. سيمكنك ذلك من عرض اجتماعاتك ومهامك في NG Academy والانضمام إليها مباشرة من الخريطة.",
    ...
    google: {
        ...
        popupScopeToSyncExplainText:
            "نحتاج إلى الاتصال بحساب Google الخاص بك لمزامنة تقويمك و/أو مهامك. سيمكنك ذلك من عرض اجتماعاتك ومهامك في NG Academy والانضمام إليها مباشرة من الخريطة.",
        popupScopeToSyncCalendar: "مزامنة التقويم الخاص بي",
        popupScopeToSyncTask: "مزامنة مهامي",
        popupCancel: "إلغاء",
