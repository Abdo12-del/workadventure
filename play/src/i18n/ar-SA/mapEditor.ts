...
const mapEditor: DeepPartial<Translation["mapEditor"]> = {
    ...
    properties: {
        ...
        openWebsite: {
            label: "فتح رابط",
            description: "فتح موقع ويب داخل NG Academy أو في تبويب جديد.",
        ...
        youtube: {
            ...
            description: "فتح فيديو يوتيوب داخل NG Academy أو في تبويب جديد.",
        ...
        googleDocs: {
            ...
            description: "فتح مستندات جوجل داخل NG Academy أو في تبويب جديد.",
        ...
        klaxoon: {
            label: "فتح Klaxoon",
            description: "فتح Klaxoon داخل NG Academy أو في تبويب جديد.",
        ...
        googleSheets: {
            ...
            description: "فتح جداول جوجل داخل NG Academy أو في تبويب جديد.",
        ...
        googleSlides: {
            label: "فتح عروض جوجل",
            description: "فتح عروض جوجل داخل NG Academy أو في تبويب جديد.",
        ...
        googleDrive: {
            ...
            description: "فتح Google Drive داخل NG Academy أو في تبويب جديد.",
        ...
        openFile: {
            label: "فتح ملف",
            description: "افتح ملفًا داخل NG Academy.",
