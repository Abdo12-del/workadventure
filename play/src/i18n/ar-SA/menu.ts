...
const menu: DeepPartial<Translation["menu"]> = {
    ...
    settings: {
        ...
        microphone: {
            ...
            workAdventureNoiseSuppression: "تقليل الضوضاء من NG Academy",
            workAdventureNoiseSuppressionDescription: "معالجة صوت الميكروفون باستخدام تقليل الضوضاء في NG Academy.",
            recommended: "موصى به",
        ...
        privacySettings: {
            ...
            explanation: 'إذا لم يكن تبويب NG Academy نشطًا، سيتم التبديل إلى "وضع الغياب".', // If the NG Academy tab is not active, it will switch to "absence mode".
