...
const warning: DeepPartial<Translation["warning"]> = {
    ...
    browserNotSupported: {
        title: "😢 지원되지 않는 브라우저",
        message: "사용 중인 브라우저({browserName})는 더 이상 NG Academy에서 지원되지 않습니다.",
        description:
            "사용 중인 브라우저가 NG Academy를 실행하기에는 너무 오래되었습니다. 계속하려면 최신 버전으로 업데이트하세요.",
        whatToDo: "무엇을 할 수 있나요?",
        option1: "{browserName}을 최신 버전으로 업데이트",
        option2: "NG Academy를 종료하고 다른 브라우저 사용",
    ...
    pwaInstall: {
        ...
        descriptionIos: "더 나은 경험과 빠른 접근을 위해 NG Academy를 홈 화면에 추가하세요.",
        feature1Title: "빠른 접근",
        feature1Description: "시작 메뉴, Dock 또는 데스크톱에서 NG Academy를 실행하세요.",
        feature2Title: "전용 앱 창",
        feature2Description: "NG Academy를 브라우저 탭과 분리해 두고 작업 표시줄에서 한눈에 찾으세요.",
        feature3Title: "컴퓨터와 함께 시작",
        feature3Description: "기기가 시작될 때 NG Academy를 실행하세요.",
        iosStepsTitle: "설치 방법",
        iosStep1: "Safari 하단의 공유 버튼(화살표가 있는 사각형)을 탭하세요.",
        iosStep2: '아래로 스크롤하여 "홈 화면에 추가"를 탭하세요.',
        iosStep3: '"추가"를 탭하여 확인하세요.',
        install: "NG Academy 앱 설치",
        installing: "설치 중…",
        skip: "브라우저에서 계속",
        continue: "브라우저에서 계속",
