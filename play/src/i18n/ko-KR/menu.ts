...
const menu: DeepPartial<Translation["menu"]> = {
    ...
    settings: {
        ...
        microphone: {
            ...
            workAdventureNoiseSuppression: "NG Academy 소음 억제",
            workAdventureNoiseSuppressionDescription: "NG Academy의 소음 억제로 마이크를 처리합니다.",
            recommended: "권장",
        ...
        privacySettings: {
            title: "자리 비움 모드",
            explanation: '브라우저에서 NG Academy 탭이 보이지 않을 때 NG Academy는 "자리 비움 모드"로 전환됩니다',
    ...
    contact: {
        gettingStarted: {
            title: "시작하기",
            description:
                "NG Academy를 사용하면 다른 사람들과 자발적으로 소통할 수 있는 온라인 공간을 만들 수 있습니다. 모든 것은 자신만의 공간을 만드는 것에서 시작됩니다. 저희 팀이 제작한 다양한 사전 제작 지도 중에서 선택하세요.",
        },
        createMap: {
            title: "지도 만들기",
