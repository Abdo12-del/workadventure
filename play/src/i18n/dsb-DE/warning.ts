...
const warning: DeepPartial<Translation["warning"]> = {
    ...
    browserNotSupported: {
        ...
        message: "Waš wobglědowak ({browserName}) se wěcej njepódpěra wót NG Academy.",
        description:
            "Waš wobglědowak jo pśestaršy, aby NG Academy wuwjadł. Pšosym aktualizěrujśo jogo na nejnowšu wersiju, aby pókšacowali.",
        whatToDo: "Co móžośo cyniś?",
        option1: "{browserName} na nejnowšu wersiju aktualizěrowaś",
        option2: "NG Academy wopušćiś a drugi wobglědowak wužywaś",
        updateBrowser: "Wobglědowak aktualizěrowaś",
        leave: "Wopušćiś",
    },
    pwaInstall: {
        title: "NG Academy instalěrowaś",
        description:
            "Instalěrujśo app za lěpše dožywjenje: malsny pśistup, start pśi zachopjenju a dožywjenje ako w app.",
        descriptionIos: "Pśidajśo NG Academy k startowemu wobrazoju za lěpše dožywjenje a malsny pśistup.",
        feature1Title: "Malsny pśistup",
        feature1Description: "Startujśo NG Academy ze startowego menija, Docka abo z desktopa.",
        feature2Title: "Swójske wokno app",
        feature2Description:
            "Źaržćo NG Academy wótkźělone wót rejtarikow wobglědowaka a namakajśo jo malsnje w swójej nadawkowej rědce.",
        feature3Title: "Ze swójim kompjutarom startowaś",
        feature3Description: "Startujśo NG Academy, gaž se waš rěd zachopijo.",
        ...
        install: "NG Academy-app instalěrowaś",
