...
const menu: DeepPartial<Translation["menu"]> = {
    ...
    settings: {
        ...
        microphone: {
            ...
            workAdventureNoiseSuppression: "Wótpóranje šuma NG Academy",
            workAdventureNoiseSuppressionDescription: "Pśeźěłajśo swój mikrofon z wótpóranim šuma NG Academy.",
        ...
        privacySettings: {
            ...
            explanation: 'Jolic až NG Academy-tab njejo aktiwny, ga aktiwěrujo se "modus njepśibytnosći".',
    ...
    contact: {
        gettingStarted: {
            ...
            description:
                "Z pomocu NG Academy móžoš stwóriś online-swět, źož móžoš se z drugimi spontanje zmakaś a rozgranjaś. Napóraj nejpjerwjej swóju kórtu. Tebje stoj k dispoziciji wjelika licba južo pśigótowanych kórtow wót našogo teama.",
        },
        createMap: {
