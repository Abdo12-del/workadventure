...
const externalModule: DeepPartial<Translation["externalModule"]> = {
    ...
    outlook: {
        ...
        popupScopeToSyncExplainText:
            "Musymy se z wašym Outlook-kontom zwězaś, aby waš kalendaŕ a/abo nadawki synchronizěrował. To wam zmóžnijo, waše ześělenja a nadawki w NG Academy wiźeś a direktnje z kórtow k nim pśiźoś.",
    ...
    google: {
        ...
        popupScopeToSyncExplainText:
            "Musymy se z wašym Google-kontom zwězaś, aby waš kalendaŕ a/abo nadawki synchronizěrował. To wam zmóžnijo, waše ześělenja a nadawki w NG Academy wiźeś a direktnje z kórtow k nim pśiźoś.",
        popupScopeToSyncCalendar: "Mój kalendaŕ synchronizěrowaś",
        popupScopeToSyncTask: "Móje nadawki synchronizěrowaś",
        popupCancel: "Pśetergnuś",
