...
const mapEditor: DeepPartial<Translation["mapEditor"]> = {
    ...
    properties: {
        ...
        openWebsite: {
            ...
            label: "リンクを開く",
            description: "NG Academy 内または新しいタブとしてウェブサイトを開きます。",
            linkLabel: "リンク URL",
        ...
        youtube: {
            ...
            description: "NG Academy 内で YouTube ビデオを開くか、新しいタブとして開きます。",
        ...
        googleDocs: {
            ...
            description: "NG Academy 内で Google ドキュメントを開くか、新しいタブとして開きます。",
        ...
        klaxoon: {
            label: "Klaxoon を開く",
            description: "NG Academy 内で Klaxoon を開くか、新しいタブとして開きます。",
        ...
        googleSheets: {
            label: "Google シートを開く",
            description: "NG Academy 内で Google シートを開くか、新しいタブとして開きます。",
        ...
        googleSlides: {
            ...
            description: "NG Academy 内で Google スライドを開くか、新しいタブとして開きます。",
        ...
        googleDrive: {
            ...
            description: "NG Academy 内で Google ドライブを開くか、新しいタブとして開きます。",
        ...
        openFile: {
            label: "ファイルを開く",
            description: "NG Academy 内でファイルを開く。",
