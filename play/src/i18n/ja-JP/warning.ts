...
const warning: DeepPartial<Translation["warning"]> = {
    ...
    browserNotSupported: {
        ...
        message: "お使いのブラウザ（{browserName}）は、NG Academyでサポートされなくなりました。",
        description:
            "お使いのブラウザはNG Academyを実行するには古すぎます。続行するには、最新バージョンに更新してください。",
        whatToDo: "何ができますか？",
        option1: "{browserName}を最新バージョンに更新する",
        option2: "NG Academyを終了して別のブラウザを使用する",
        updateBrowser: "ブラウザを更新",
        leave: "終了",
    },
    pwaInstall: {
        title: "NG Academyをインストール",
        description:
            "より快適に使えるよう、アプリをインストールしましょう。すばやくアクセスでき、起動時に読み込まれ、アプリのように利用できます。",
        descriptionIos: "より快適にすばやくアクセスできるよう、NG Academy をホーム画面に追加しましょう。",
        feature1Title: "すばやくアクセス",
        feature1Description: "スタートメニュー、Dock、またはデスクトップから NG Academy を起動できます。",
        feature2Title: "専用のアプリウィンドウ",
        feature2Description: "NG Academy をブラウザのタブから分けて、タスクバーですぐに見つけられます。",
        feature3Title: "起動時に開始",
        feature3Description: "デバイスの起動時に NG Academy を起動します。",
