...
const menu: DeepPartial<Translation["menu"]> = {
    ...
    settings: {
        ...
        microphone: {
            ...
            workAdventureNoiseSuppression: "NG Academy ノイズ抑制",
            workAdventureNoiseSuppressionDescription: "NG Academy のノイズ抑制でマイク音声を処理します。",
            recommended: "推奨",
        ...
        privacySettings: {
            title: "離席モード",
            explanation: "ブラウザの NG Academy タブが表示されていない間、NG Academy は離席モードに切り替わります。",
    ...
    contact: {
        gettingStarted: {
            title: "入門",
            description:
                "NG Academy を使用すると、他のユーザと自然にコミュニケーションできるオンラインスペースを作成することができます",
        },
        createMap: {
            title: "マップを作成します",
