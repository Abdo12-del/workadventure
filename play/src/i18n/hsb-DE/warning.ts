...
const warning: DeepPartial<Translation["warning"]> = {
    ...
    browserNotSupported: {
        ...
        message: "Waš wobhladowak ({browserName}) so wjace njepodpěruje wot NG Academy.",
        description:
            "Waš wobhladowak je přestarši, zo by NG Academy wuwjedł. Prošu aktualizujće jón na najnowšu wersiju, zo byšće pokročowali.",
        whatToDo: "Što móžeće činić?",
        option1: "{browserName} na najnowšu wersiju aktualizować",
        option2: "NG Academy wopušćić a druhi wobhladowak wužiwać",
        updateBrowser: "Wobhladowak aktualizować",
        leave: "Wopušćić",
    },
    pwaInstall: {
        title: "NG Academy instalować",
        description:
            "Instalujće app za lěpše dožiwjenje: spěšny přistup, start při startowanju a dožiwjenje kaž w app.",
        descriptionIos: "Přidajće NG Academy na swój startowy wobraz za lěpše dožiwjenje a spěšny přistup.",
        feature1Title: "Spěšny přistup",
        feature1Description: "Startujće NG Academy ze startoweho menija, Docka abo z desktopa.",
        feature2Title: "Swójske wokno app",
        feature2Description:
            "Dźeržće NG Academy wot browserowych rajtarkow dźělene a namakajće jo spěšnje w swojej nadawkowej lajsće.",
        feature3Title: "Z wašim kompjutorom startować",
        feature3Description: "Startujće NG Academy, hdyž so waš grat startuje.",
        ...
        install: "NG Academy-app instalować",
