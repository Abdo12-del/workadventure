...
const externalModule: DeepPartial<Translation["externalModule"]> = {
    ...
    outlook: {
        ...
        popupScopeToSyncExplainText:
            "Dyrbimy so z wašim Outlook-kontom zwjazać, zo by waš kalender a/abo nadawki synchronizował. To wam zmóžnja, waše zećělenja a nadawki w NG Academy widźeć a direktnje z kartow k nim wobdźělić.",
    ...
    google: {
        ...
        popupScopeToSyncExplainText:
            "Dyrbimy so z wašim Google-kontom zwjazać, zo by waš kalender a/abo nadawki synchronizował. To wam zmóžnja, waše zećělenja a nadawki w NG Academy widźeć a direktnje z kartow k nim wobdźělić.",
        popupScopeToSyncCalendar: "Mój kalender synchronizować",
        popupScopeToSyncTask: "Moje nadawki synchronizować",
        popupCancel: "Přetorhnyć",
