...
const mapEditor: DeepPartial<Translation["mapEditor"]> = {
    ...
    properties: {
        ...
        openWebsite: {
            label: "打开链接",
            description: "在 NG Academy 内或作为新标签页打开网站。",
            linkLabel: "链接 URL",
        ...
        youtube: {
            label: "打开 YouTube 视频",
            description: "在 NG Academy 内或作为新标签页打开 YouTube 视频。",
        ...
        googleDocs: {
            label: "打开 Google 文档",
            description: "在 NG Academy 内或作为新标签页打开 Google 文档。",
        ...
        klaxoon: {
            label: "打开 Klaxoon",
            description: "在 NG Academy 内或作为新标签页打开 Klaxoon。",
        ...
        googleSheets: {
            label: "打开 Google 表格",
            description: "在 NG Academy 内或作为新标签页打开 Google 表格。",
        ...
        googleSlides: {
            label: "打开 Google 幻灯片",
            description: "在 NG Academy 内或作为新标签页打开 Google 幻灯片。",
        ...
        googleDrive: {
            ...
            description: "在 NG Academy 内或作为新标签页打开 Google 云端硬盘。",
        ...
        openFile: {
            label: "打开文件",
            description: "在 NG Academy 内打开文件。",
            error: "请输入有效的文件",
            disabled: "文件集成已禁用。",
            fileUrlLabel: "文件 URL",
            uploadFile: {
