...
const menu: DeepPartial<Translation["menu"]> = {
    ...
    settings: {
        ...
        microphone: {
            ...
            workAdventureNoiseSuppression: "NG Academy 噪声抑制",
            workAdventureNoiseSuppressionDescription: "使用 NG Academy 的噪声抑制处理你的麦克风。",
            recommended: "推荐",
        ...
        privacySettings: {
            title: "离开模式设置",
            explanation:
                '当NG Academy标签页在后台时, 会切换到"离开模式"。在该模式中，你可以选择自动禁用摄像头 和/或 麦克风 直到标签页显示。',
    ...
    contact: {
        gettingStarted: {
            title: "开始",
            description:
                "NG Academy使你能够创建一个在线空间，与他们自然地交流。这都从创建你自己的空间开始。从我们的团队预制的大量选项中选择一个地图。",
        },
        createMap: {
            title: "创建地图",
