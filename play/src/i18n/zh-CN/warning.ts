...
const warning: DeepPartial<Translation["warning"]> = {
    ...
    browserNotSupported: {
        title: "😢 不支持的浏览器",
        message: "您的浏览器（{browserName}）不再受 NG Academy 支持。",
        description: "您的浏览器太旧，无法运行 NG Academy。请更新到最新版本以继续。",
        whatToDo: "您可以做什么？",
        option1: "将 {browserName} 更新到最新版本",
        option2: "退出 NG Academy 并使用其他浏览器",
        updateBrowser: "更新浏览器",
        leave: "离开",
    },
    pwaInstall: {
        ...
        descriptionIos: "将 NG Academy 添加到主屏幕，以获得更好的体验和快速访问。",
        feature1Title: "快速访问",
        feature1Description: "从开始菜单、Dock 或桌面启动 NG Academy。",
        feature2Title: "独立应用窗口",
        feature2Description: "让 NG Academy 与浏览器标签页分开，并可在任务栏中一眼找到它。",
        feature3Title: "随电脑启动",
        feature3Description: "在设备启动时启动 NG Academy。",
        iosStepsTitle: "如何安装",
        iosStep1: "在 Safari 底部点击“分享”按钮（带箭头的方框）。",
        iosStep2: "向下滚动并点击“添加到主屏幕”。",
        iosStep3: "点击“添加”以确认。",
        install: "安装 NG Academy 应用",
        installing: "安装中…",
        skip: "在浏览器中继续",
        continue: "在浏览器中继续",
        neverShowPage: "不再询问",
