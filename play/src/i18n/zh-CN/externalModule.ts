...
const externalModule: DeepPartial<Translation["externalModule"]> = {
    ...
    discord: {
        integration: "集成",
        explainText:
            "通过在此处连接您的 Discord 账户，您将能够在 NG Academy 聊天中直接接收消息。同步服务器后，我们将创建其中包含的房间，您只需在 NG Academy 聊天中加入它们即可。",
        login: "连接到 Discord",
        ...
        guilds: "Discord 服务器",
        guildExplain: "选择要添加到 NG Academy 聊天界面的频道。\n",
    },
    outlook: {
        signIn: "使用 Outlook 登录",
        popupScopeToSync: "连接我的 Outlook 账户",
        popupScopeToSyncExplainText:
            "我们需要连接到您的 Outlook 账户以同步您的日历和/或任务。这将允许您在 NG Academy 中查看您的会议和任务，并直接从地图加入它们。",
    ...
    google: {
        ...
        popupScopeToSyncExplainText:
            "我们需要连接到您的 Google 账户以同步您的日历和/或任务。这将允许您在 NG Academy 中查看您的会议和任务，并直接从地图加入它们。",
        popupScopeToSyncCalendar: "同步我的日历",
        popupScopeToSyncTask: "同步我的任务",
        popupCancel: "取消",
