...
const menu: DeepPartial<Translation["menu"]> = {
    ...
    settings: {
        ...
        microphone: {
            ...
            workAdventureNoiseSuppression: "Supressió de soroll de NG Academy",
            workAdventureNoiseSuppressionDescription: "Processa el micròfon amb la supressió de soroll de NG Academy.",
        ...
        privacySettings: {
            ...
            explanation:
                'Quan la pestanya de NG Academy al seu navegador no és visible, NG Academy cambia al "mode no present"',
    ...
    contact: {
        gettingStarted: {
            title: "Començar",
            description:
                "NG Academy us permet crear un espai en línia per comunicar-vos espontàneament amb altres. I tot comença creant el vostre propi espai. Escolliu entre una gran selecció de mapes prefabricats pel nostre equip.",
        },
        createMap: {
