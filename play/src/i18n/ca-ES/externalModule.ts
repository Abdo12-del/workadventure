...
const externalModule: DeepPartial<Translation["externalModule"]> = {
    ...
    outlook: {
        ...
        popupScopeToSyncExplainText:
            "Necessitem connectar-nos al vostre compte d'Outlook per sincronitzar el vostre calendari i/o tasques. Això us permetrà veure les vostres reunions i tasques a NG Academy i unir-vos-hi directament des del mapa.",
    ...
    google: {
        ...
        popupScopeToSyncExplainText:
            "Necessitem connectar-nos al vostre compte de Google per sincronitzar el vostre calendari i/o tasques. Això us permetrà veure les vostres reunions i tasques a NG Academy i unir-vos-hi directament des del mapa.",
        popupScopeToSyncCalendar: "Sincronitzar el meu calendari",
        popupScopeToSyncTask: "Sincronitzar les meves tasques",
        popupCancel: "Cancel·lar",
