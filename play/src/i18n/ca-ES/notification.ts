...
const notification: DeepPartial<Translation["notification"]> = {
    ...
    help: {
        ...
        content:
            "No et perdis cap discussió. Activa les notificacions per ser notificat quan algú vulgui parlar amb tu, fins i tot si no estàs a la pestanya de NG Academy.",
        firefoxContent:
