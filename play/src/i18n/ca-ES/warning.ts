...
const warning: DeepPartial<Translation["warning"]> = {
    ...
    browserNotSupported: {
        ...
        message: "El vostre navegador ({browserName}) ja no és compatible amb NG Academy.",
        description:
            "El vostre navegador és massa antic per executar NG Academy. Si us plau, actualitzeu-lo a la darrera versió per continuar.",
        whatToDo: "Què podeu fer?",
        option1: "Actualitzar {browserName} a la darrera versió",
        option2: "Sortir de NG Academy i utilitzar un navegador diferent",
        updateBrowser: "Actualitzar navegador",
        leave: "Sortir",
    },
    pwaInstall: {
        title: "Instal·lar NG Academy",
        description:
            "Instal·la l'app per a una millor experiència: accés ràpid, càrrega a l'inici i una experiència d'aplicació.",
        descriptionIos: "Afegeix NG Academy a la pantalla d'inici per a una millor experiència i un accés ràpid.",
        feature1Title: "Accés ràpid",
        feature1Description: "Obre NG Academy des del menú d'inici, el Dock o l'escriptori.",
        feature2Title: "Finestra d'app dedicada",
        feature2Description:
            "Mantén NG Academy separat de les pestanyes del navegador i troba'l d'un cop d'ull a la barra de tasques.",
        feature3Title: "Inicia amb l'ordinador",
        feature3Description: "Obre NG Academy quan el dispositiu s'iniciï.",
        ...
        install: "Instal·lar l'app NG Academy",
