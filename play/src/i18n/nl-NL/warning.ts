...
const warning: DeepPartial<Translation["warning"]> = {
    ...
    browserNotSupported: {
        ...
        message: "Uw browser ({browserName}) wordt niet meer ondersteund door NG Academy.",
        description:
            "Uw browser is te oud om NG Academy uit te voeren. Werk deze bij naar de nieuwste versie om door te gaan.",
        whatToDo: "Wat kunt u doen?",
        option1: "{browserName} bijwerken naar de nieuwste versie",
        option2: "NG Academy verlaten en een andere browser gebruiken",
        updateBrowser: "Browser bijwerken",
        leave: "Verlaten",
    },
    pwaInstall: {
        title: "NG Academy installeren",
        description:
            "Installeer de app voor een betere ervaring: snelle toegang, starten bij het opstarten en een app-achtige ervaring.",
        descriptionIos: "Voeg NG Academy toe aan je beginscherm voor een betere ervaring en snelle toegang.",
        feature1Title: "Snelle toegang",
        feature1Description: "Start NG Academy vanuit je startmenu, Dock of vanaf je bureaublad.",
        feature2Title: "Eigen appvenster",
        feature2Description:
            "Houd NG Academy gescheiden van je browsertabbladen en vind NG Academy in een oogopslag terug op je taakbalk.",
        feature3Title: "Start met je computer",
        feature3Description: "Start NG Academy wanneer je apparaat opstart.",
        ...
        install: "NG Academy-app installeren",
