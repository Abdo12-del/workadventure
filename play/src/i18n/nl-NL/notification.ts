...
const notification: DeepPartial<Translation["notification"]> = {
    ...
    help: {
        ...
        content:
            "Mis geen enkele discussie. Sta meldingen toe om gewaarschuwd te worden wanneer iemand met je wil praten, zelfs als je niet op het NG Academy-tabblad bent.",
        firefoxContent:
