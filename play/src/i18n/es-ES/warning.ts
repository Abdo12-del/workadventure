...
const warning: DeepPartial<Translation["warning"]> = {
    ...
    browserNotSupported: {
        ...
        message: "Su navegador ({browserName}) ya no es compatible con NG Academy.",
        description:
            "Su navegador es demasiado antiguo para ejecutar NG Academy. Por favor, actualícelo a la última versión para continuar.",
        whatToDo: "¿Qué puede hacer?",
        option1: "Actualizar {browserName} a la última versión",
        option2: "Salir de NG Academy y usar un navegador diferente",
    ...
    pwaInstall: {
        ...
        descriptionIos:
            "Añade NG Academy a tu pantalla de inicio para disfrutar de una mejor experiencia y un acceso rápido.",
        feature1Title: "Acceso rápido",
        feature1Description: "Abre NG Academy desde tu menú Inicio, Dock o escritorio.",
        feature2Title: "Ventana de aplicación dedicada",
        feature2Description:
            "Mantén NG Academy separado de las pestañas del navegador y encuéntralo de un vistazo en la barra de tareas.",
        feature3Title: "Iniciar con el ordenador",
        feature3Description: "Abre NG Academy cuando se inicie tu dispositivo.",
        ...
        install: "Instalar la app NG Academy",
