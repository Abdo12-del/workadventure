...
const menu: BaseTranslation = {
    ...
    settings: {
        ...
        microphone: {
            ...
            workAdventureNoiseSuppression: "NG Academy noise suppression",
            workAdventureNoiseSuppressionDescription: "Process your microphone with NG Academy's noise suppression.",
            recommended: "Recommended",
        ...
        privacySettings: {
            title: "Away mode",
            explanation: 'While the NG Academy tab in your browser is not visible. NG Academy switches to "away mode"',
    ...
    contact: {
        gettingStarted: {
            ...
            description:
                "NG Academy allows you to create an online space to communicate spontaneously with others. And it all starts with creating your own space. Choose from a large selection of prefabricated maps by our team.",
        },
        createMap: {
