...
const externalModule: BaseTranslation = {
    ...
    outlook: {
        ...
        popupScopeToSyncExplainText:
            "We need to connect to your Outlook account to synchronize your calendar and/or tasks. This will allow you to view your meetings and tasks in NG Academy and join them directly from the map.",
    ...
    google: {
        ...
        popupScopeToSyncExplainText:
            "We need to connect to your Google account to synchronize your calendar and/or tasks. This will allow you to view your meetings and tasks in NG Academy and join them directly from the map.",
        popupScopeToSyncCalendar: "Synchronize my calendar",
        popupScopeToSyncTask: "Synchronize my tasks",
        popupCancel: "Cancel",
