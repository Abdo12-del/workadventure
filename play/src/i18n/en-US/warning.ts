...
const warning: BaseTranslation = {
    ...
    browserNotSupported: {
        ...
        message: "Your browser ({browserName}) is no longer supported by NG Academy.",
        description: "Your browser is too old to run NG Academy. Please update to the latest version to continue.",
        whatToDo: "What can you do?",
        option1: "Update {browserName} to the latest version",
        option2: "Leave NG Academy and use a different browser",
        updateBrowser: "Update Browser",
        leave: "Leave",
    },
    pwaInstall: {
        title: "Install NG Academy",
        description:
            "Install the app for a better experience: quick access, load on startup and an app-like experience.",
        descriptionIos: "Add NG Academy to your Home Screen for a better experience and quick access.",
        feature1Title: "Quick access",
        feature1Description: "Launch NG Academy from your Start menu, Dock, or desktop.",
        feature2Title: "Dedicated app window",
        feature2Description:
            "Keep NG Academy separate from your browser tabs and find NG Academy at a glance in your taskbar.",
        feature3Title: "Start with your computer",
        feature3Description: "Launch NG Academy when your device starts.",
        ...
        install: "Install NG Academy App",
