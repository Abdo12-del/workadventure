...
| خرائط المدرسة   | ‏`maps/ng-academy/`                                    | مدخل + 7 فصول (فصل الحساب مطوَّر: معداد على كل طاولة + ركن معداد تفاعلي) + مكتبة + مختبر + مسرح + قاعات — مولَّدة بسكربت، ومزيّنة ببلاطات LimeZu مقصوصة ومرخّصة (‏LICENSE.assets، ~5KB إجمالًا) |
