...
| خرائط المدرسة   | ‏`maps/ng-academy/`                                    | مدخل + 7 فصول (فصل الحساب مطوَّر: سبورة رياضيات + ساعة + خط أعداد + معداد على كل طاولة + ركن معداد تفاعلي) + مكتبة + مختبر + مسرح + قاعات (مولَّدة بسكربت) |
